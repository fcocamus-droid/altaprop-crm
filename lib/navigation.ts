import { Home, Building2, FileText, Users, Settings, Plus, CreditCard, Crown, Calendar, UserSearch, KeyRound, Globe, LayoutGrid, GitMerge, Database, TrendingUp, MessageSquare } from 'lucide-react'
...
export const menuItems = [
  ...
  { href: '/dashboard/conversaciones', label: 'Conversaciones', icon: MessageSquare, roles: [...ADMIN_ROLES, ROLES.AGENTE] as UserRole[] },
