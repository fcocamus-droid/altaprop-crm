      ...
      <div className="container py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-navy-100">
              <li className="flex items-center gap-2"><Phone className="h-4 w-4" />+56 9 7332 3296</li>
              <li className="flex items-center gap-2"><Mail className="h-4 w-4" />contacto@altaprop.cl</li>
              <li className="flex items-center gap-2"><MapPin className="h-4 w-4" />Santiago, Chile</li>
            </ul>
          </div>
        </div>
        <div className="mt-8 pt-8 border-t border-navy-500 text-center text-sm text-navy-200">
